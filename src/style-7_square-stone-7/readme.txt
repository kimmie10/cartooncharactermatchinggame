...
True Type Font: Square Stone-7 version 1.0


EULA
-==-
The font Square Stone-7 is freeware for home use only.


DESCRIPTION
-=========-
Original square font like massive stone constructions.

Files in square_stone-7.zip:
       	readme.txt     			this file;
        square_stone-7.ttf    		regular font;
	square_stone-7_screen.png	preview image.
